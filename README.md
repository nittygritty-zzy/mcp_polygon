...
```bash
# Claude CLI
claude mcp add polygon -e POLYGON_API_KEY=your_api_key_here -- uvx --from git+https://github.com/nittygritty-zzy/mcp_polygon@v0.5.1 mcp_polygon
```
...
```json
{
    "mcpServers": {
        "polygon": {
            ...
            "args": [
                "--from",
                "git+https://github.com/nittygritty-zzy/mcp_polygon@v0.5.1",
                "mcp_polygon"
            ],
            "env": {
